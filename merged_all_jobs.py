...
df_annual_salary=df_all[df_all.Salaire.notnull()&df_all.Salaire.str.contains('par an')]
df_mensuel_salary=df_all[df_all.Salaire.notnull()&df_all.Salaire.str.contains('par mois')]
